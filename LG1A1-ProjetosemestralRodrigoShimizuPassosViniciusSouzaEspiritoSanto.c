// Instituto Federal de Educa��o, Ci�ncia e Tecnologia de S�o Paulo
// Projeto semestral para a disciplina de L�gica de Programa��o do primeiro semestre do curso de Tecnologia em An�lise e Desenvolvimento de Sistemas
// Docente: Francisco Ver�ssimo Luciano
// Discentes: Rodrigo Shimizu Passos SP306896X e Vinicius Souza do Esp�rito Santo SP3068901
// Projeto entregue at� 07/08/2021
// Este projeto foi produzido em linguagem C, com o objetivo de realizar um teste representacional, para compreender os tipos representacionais que predominam
// nos usu�rios do programa, al�m de conter funcionalidades como aba de administrador, cadastro de novo question�rio para uso, apoio te�rico e visualiza��o do
// question�rio atual.
//  link para v�deo contendo a apresenta��o do programa: https://youtu.be/n45WCPpaBUM
#include <stdio.h>
#include <string.h>
#include <locale.h>
#include <stdlib.h>
...
int criacaoarq()
{
	...
	if (!file)
	{
		printf("Erro ao criar o arquivo %s", runderline); // mensagem de erro para o caso de n�o ser poss�vel criar o arquivo
	}
	printf("Foi criado o arquivo %80s \n", runderline);
	int f = 0;
...
int visualizacao()
{
	...
	fprintf(ver, "========================================================================================================================================================================================================================================================================================================================================================================\n\n");
	fprintf(ver, "1 %70s|%70s.|%70s.|%70s.|%70s.\n", mquest[1], mquest[2], mquest[3], mquest[4], mquest[5]);
	fprintf(ver, "2 %70s|%70s.|%70s.|%70s.|%70s.\n", mquest[6], mquest[7], mquest[8], mquest[9], mquest[10]);
	fprintf(ver, "3 %70s|%70s.|%70s.|%70s.|%70s.\n", mquest[11], mquest[12], mquest[13], mquest[14], mquest[15]);
	fprintf(ver, "4 %70s|%70s.|%70s.|%70s.|%70s.\n", mquest[16], mquest[17], mquest[18], mquest[19], mquest[20]);
	fprintf(ver, "5 %70s|%70s.|%70s.|%70s.|%70s.\n", mquest[21], mquest[22], mquest[23], mquest[24], mquest[25]);
	fprintf(ver, "\n========================================================================================================================================================================================================================================================================================================================================================================");
	fclose(ver);
...
{
	FILE *sobrerep;
	sobrerep = fopen("REFERENCIAL_TEORICO.txt", "w");
	if (!sobrerep)
	{
		printf("Erro ao criar o arquivo."); // mensagem de erro para o caso de n�o ser poss�vel criar o arquivo
	}
